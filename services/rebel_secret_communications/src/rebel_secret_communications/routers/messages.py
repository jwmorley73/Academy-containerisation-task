"""Defines the methods for the `/secret_messages/` endpoint
...
from rebel_secret_communications import database


message_router = fastapi.routing.APIRouter(prefix="/secret_messages")
